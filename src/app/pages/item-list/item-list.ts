...
import { ModalIntroductionComponent } from "../share/modal-introduction/modal-introduction.component";
...
export class ItemListPage extends BasePage {
  ...
  async ionViewDidEnter() {
    ...
    if (!this.sharedService.alreadyShow) {
      const modal = await this.modalController.create({
        component: ModalIntroductionComponent,
        showBackdrop: true,
        cssClass: "modal-sauvegarde",
        backdropDismiss: true,
      });
      await modal.present();
      this.sharedService.alreadyShow = true;
    }
  }
  ...
  compareSortOption(o1: any, o2: any) {
    return o1 && o2
      ? o1.sortBy === o2.sortBy && o1.sortByField === o2.sortByField
      : o1 === o2;
  }
