    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            path: "brands",
            loadChildren: () =>
              import("../pages/brand-list/brand-list.module").then(
                (m) => m.BrandListPageModule
              ),
          },
          {
            path: "categories",
          ...
          },
          {
            ...
            loadChildren: () =>
              ...
              ).then((m) => m.SubCategoryListPageModule),
          },
          {
            path: "items/:itemId",
            loadChildren: () =>
          ...
          },
          {
            ...
            loadChildren: () =>
              import("../pages/review-list/review-list.module").then(
                (m) => m.ReviewListPageModule
              ),
          },
          {
        ...
        children: [
          ...
          },
          {
            ...
            loadChildren: () =>
              ...
              ).then((m) => m.OrderDetailPageModule),
          },
          {
            path: "pages/:id/:slug",
            loadChildren: () =>
              import("../pages/page/page.module").then((m) => m.PageViewModule),
          },
        ],
      },
      {
